...
import app.GraphPoetApp.graphMetrics;
...
public class NetworkTopologyApp {
	...
	static NetworkTopology G = new NetworkTopology();
	List<String> VertexType = Arrays.asList("Computer", "Router", "Server");

	public static void main(String[] args) {
		NetworkTopologyApp f = new NetworkTopologyApp();
		JFrame frame = new JFrame("NetworkTopologyApp");
			...
			input.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (JFileChooser.APPROVE_OPTION == fc.showOpenDialog(new JFrame())) {
						...
						try {
							G = new NetworkTopologyFactory().createGraph(path);
