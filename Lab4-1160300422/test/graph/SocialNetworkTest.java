...
public class SocialNetworkTest extends ConcreteGraphTest {
	...
	public void testException() {
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/1.txt");
			assert false;
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/2.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/3.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/4.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/5.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/6.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/7.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/8.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidLabel);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/9.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidVertexType);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/10.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/11.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof NoAppropriateAttributes);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/12.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof NoAppropriateAttributes);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/13.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/14.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/15.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/16.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidLabel);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/17.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidEdgeType);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/18.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/19.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidWeight);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/20.txt");
		} catch (graphExceptions e) {
			assert false;
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/21.txt");
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/22.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof InvalidCommander);
		}
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/23.txt");
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/24.txt");
			assertEquals(3, g.edges().size());
			assert false;
		} catch (graphExceptions ex) {
		...
		try {
			SocialNetwork g = new SocialNetworkFactory()
					.createGraph("test/graph/SocialNetworkExceptionTest/25.txt");
			assert false;
		} catch (graphExceptions ex) {
			assertTrue(ex instanceof NoAppropriateAttributes);
		}
	...
	public void testFactory() {
		SocialNetwork g;
		try {
			g = new SocialNetworkFactory().createGraph("test/graph/SocialNetworkTest.txt");
			assertEquals(3, g.edges().size());
