...
public class GraphPoetTest extends ConcreteGraphTest {
	...
	public void testGraphPoetFactory() {
		GraphPoet g;
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetTest.txt");
	...
	public void testException() {
		GraphPoet g;
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/1.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/2.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/3.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/4.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidLabel;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/5.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/6.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidVertexType;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/7.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/8.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidLabel;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/9.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidVertexType;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/10.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/11.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidEdgeType;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/12.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/13.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidLabel;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/14.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidEdgeType;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/15.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidWeight;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/16.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidWeight;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/17.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof DirectededgeWithoutDirection;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/18.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof NotExistedVertices;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/19.txt");
			assert false;
		} catch (graphExceptions e) {
			assert e instanceof InvalidCommander;
		}
		try {
			g = new GraphPoetFactory().createGraph("test/graph/GraphPoetExceptionTest/20.txt");
			assertEquals(5, g.edges().size());
		} catch (graphExceptions e) {
			assert false;
		}
