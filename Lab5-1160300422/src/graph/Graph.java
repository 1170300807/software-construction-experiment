...
public interface Graph<L, E> {
	 ...
	 *         label or an edge with existed source and target; otherwise false (and
	 *         this graph is not modified)
	 */
	 ...
	 * 
	 * @param edge
	 *            label for the new edge sande a String consist of vertices' labels
	 *            of edge,to make sure there is no repeated edge
	 * @return true if this graph did not already include an edge with the given
	 *         label or an edge with existed source and target; otherwise false (and
	 *         this graph is not modified)
	 */
	public abstract boolean addEdge(String sande, E edge);
	...
	/**
	 * modify an existed edge
	 * 
	 * @param edge
	 */
	public abstract boolean modifyEdge(E edge);
