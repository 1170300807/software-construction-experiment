...
public class Person extends Vertex {
	...
	public void fillVertexInfo(String[] args) {
		...
		assert args[0].equals("M") || args[0].equals("F");

		try {
			assert Integer.valueOf(args[1]) > 0;
	...
	public String toString() {
		return "<\"" + super.getLabel() + "\", \"Person\", <" + "\"" + sex + "\", \"" + age + "\">>";
	}
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		Person v = (Person) o;
		return super.getLabel().equals(v.getLabel()) && this.sex.equals(v.getSex()) && this.age == v.getAge();
	}
